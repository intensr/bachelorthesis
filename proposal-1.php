...
<abbr title="Virtual Reality">VR</abbr>)?</li>
      ...
      <ol class="c-table-of-contents">
        ...
        <li><a href="#motivation-und-leitfragen">Motivation und Leitfragen</a></li>
...
Pioniere</strong></a></div>
          <ol>
            ...
            <li><a href="#medien-fuer-die-massen">Medien für die Massen</a></li>
            <li><a href="#digitale-mobilitaet">Digitale Mobilität</a></li>
            <li><a href="#internet">Internet</a></li>
          </ol>
        </li>
        <li class="c-li-lead">
          <div class="c-li-lead__content"><a href="#artifizielle-realitaeten">Kapitel <strong>Artifizielle Realitäten</strong></a></div>
          <ol>
            <li><a href="#head-mounted-displays-virtual-augmented-und-mixed-reality">Head Mounted Displays / Virtual-, Augmented- und Mixed Reality</a></li>
            <li><a href="#the-next-big-thing-der-software-aera"><i>The Next Big Thing</i> der Software Ära</a></li>
          </ol>
        </li>
        <li class="c-li-lead">
          <div class="c-li-lead__content"><a href="#mobile-vr">Kapitel <strong>MobileVR</strong></a></div>
        </li>
        <li class="c-li-lead">
          <div class="c-li-lead__content"><a href="#webvr">Kapitel <strong>WebVR</strong></a></div>
        </li>
        <li><a href="#resumee">Resümee</a></li>
        <li><a href="#quellen">Quellen</a></li>
      </ol>

      <h2 id="motivation-und-leitfragen">Motivation und Kernfragen</h2>
...
Gruppe tötet und rivalisierenden Artgenossen, welche den Zugang zur einzigen Wasserquelle unterbinden, erschwert.</p>
      <p class="o-p--tie">Eines Morgens erwacht die Gruppe neben einem schwarzen Monolithen, welcher sich unbemerkt, im Mittelpunkt ihrer materialisiert. Die
Gruppe fürchtet sich zunächst vor dem unnatürlich wirkenden Objekt, begutachtet es jedoch gleichermaßen neugierig. Die Auswirkungen des Monolithen auf die
...
sein Werkzeug in den Himmel.</p>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="183" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="1" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>
...
gesellschaftliche Entwicklung des Menschen durch die kontinuierliche Fluktuation und Wechselwirkung technologischer Errungenschaften.</p>
      ...
      <p class="o-p--tie">Die Technologie als solche, welche in Kubricks filmischen Epos durch den Knochen verkörpert wird, hat sich in den letzten
Jahrhunderten und speziell
...
Betrachter eine hohe Anzahl an Beispielen für diese Entwicklung. Bleibt jener im Kontext von buchstäblich <span class="c-ref" data-ref-source-id="2"
data-ref-type="ref" data-ref-desc=""><i>geworfenen Objekten</i></span>, so führt kein Weg an Steve Jobs’
Unternehmung Apple vorbei.</p>
      <p class="o-p--tie">Intelligente Produkte wie tragbare Recheneinheiten, Musikplayer und Smartphones revolutionieren seit ihrer <span class="c-ref"
data-ref-source-id="3" data-ref-type="bsp" data-ref-desc="" data-ref-parameter="?t=1m24s">Vorstellung</span> den Kurs der
...
jeglicher primärer Medien in einer Vielzahl von Anwendungsbereichen und gesellschaftlichen Konstrukten.</p>
      ...
      <h2 id="aufbau-und-struktur">Aufbau und Struktur</h2>
...
Fragestellung eruiert. Etwaig ethische Konsequenzen und mögliche Auswirkungen der gesellschaftlichen Paradigmenwechsel werden primär untersucht.</p>
      ...
      <h2 id="beschleunigung-von-und-mit-software">Beschleunigung von und mit Software</h2>
...
relevanten Eigenschaften der industriellen Revolution für die Entwicklung von Software manifestieren sich durch die <span class="c-ref"
data-ref-source-id="185"
...
Intel-Mitbegründer Gordon E. Moore erstmals 1964 aufmerksam wird. Im sog. mooreschen Gesetz (Moore's Law) verweist er darauf, dass sich die Rechenleistung,
welche für
...
law – the doubling of transistor counts every two years. The y-axis is logarithmic, so the line corresponds to exponential growth."/>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="10" data-ref-type="vgl" data-ref-desc="Transistor counts for integrated circuits plotted against their dates
of
introduction. The curve shows Moore's law – the doubling of transistor counts every two years. The y-axis is logarithmic, so the line corresponds to
exponential
growth." data-ref-hide></span>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="11" data-ref-type="vgl" data-ref-desc="Moore's Law, The Fifth Paradigm." data-ref-hide></span>
        </div>
      </div>

      <p></p><!--hotfix p for kneeknote establishing-->

      <p>Auch wenn das Paradigma, die Anzahl der Transistoren auf einem Computerchip, dieses Gesetzes in seinem Ursprungsprinzip mit der <span class="c-ref"
data-ref-source-id="186" data-ref-type="ref">Roadmap</span> von Intel und
...
essentiellen Gültigkeit des mooreschen Gesetzes in <span class="c-ref" data-ref-source-id="14" data-ref-type="ref" data-ref-desc="Martin Strobel im
">absehbarer
...
Schaltkreise, Spintronik, Supraleiter oder Quantencomputer darstellen.</p>
      <p class="o-p--tie">Die exponentielle technische Beschleunigung mithilfe von Technologie bzw. Computersystemen, angedeutet im mooreschen Gesetz und den
...
erstmals geprägt von <span class="c-ref" data-ref-source-id="16" data-ref-type="ref" data-ref-desc="">Vernor Vinge.</span> Dabei geht die erste bekannte
Erwähnung
der Theorie auf eine 1958 stattfindende Unterhaltung zwischen
Stanislaw Ulam und John von Neumann <span class="c-ref" data-ref-source-id="187" data-ref-type="ref" data-ref-desc="S.5 ">zurück.</span> Die <abbr
title="Technologische Singularität">TS</abbr> beschreibt den Zeitpunkt, ab dem Maschinen mittels künstlicher Intelligenz (AI/KI)
...
sie wie folgt:</p>
      ...
      <blockquote>
        <p>Let an ultraintelligent machine be defined as a machine that can far surpass all the intellectual activities of any man however clever. Since the
design of machines is one of these intellectual activities, an ultra-intelligent machine could design even better machines; there would then unquestionably be
an „intelligence explosion,“ and the intelligence of man would be left far behind. Thus the first ultraintelligent machine is the last invention that man need
ever make, provided that the machine is docile enough to tell us how to keep it under control.</p>
        <cite><span class="c-ref" data-ref-source-id="18" data-ref-type="zitat" data-ref-desc="">Irving John Good</span></cite>
      </blockquote>

      <p>Auch in popkultureller Hinsicht erfreut sich dieses Konzept besonderer Beliebtheit. Speziell in Filmen, Serien oder Videospielen wie <span
class="c-ref" data-ref-source-id="20" data-ref-type="ref" data-ref-desc="" data-ref-hide-kneenote>Transcendence</span>,
<span class="c-ref" data-ref-source-id="21" data-ref-type="ref" data-ref-desc="" data-ref-hide-kneenote>Her</span>, <span class="c-ref" data-ref-source-id="22"
data-ref-type="ref" data-ref-desc="" data-ref-hide-kneenote>Matrix</span>, <span class="c-ref" data-ref-source-id="23" data-ref-type="ref" data-ref-desc=""
data-ref-hide-kneenote>Terminator</span>,
 <span class="c-ref" data-ref-source-id="24" data-ref-type="ref" data-ref-desc="" data-ref-hide-kneenote>Westworld</span>, <span class="c-ref"
data-ref-source-id="25"
...
data-ref-hide-kneenote>DeusEx</span>,
  <span class="c-ref" data-ref-source-id="27" data-ref-type="ref" data-ref-desc="" data-ref-hide-kneenote>Portal</span> usw. wird diese Thematik auf
verschiedene
...
möglichen Konsequenzen solcher Auswirkungen und zukünftiger Entwicklungen sind bilden die Grundlage fundamentaler Diskussionen.</p>
      ...
      <p class="o--p-tie werner">Wie alle unbewiesenen Theorien muss sich auch die technologische Singularität diversen Kritikpunkten aussetzen. Durch die
aufgelockerte Auslegung des
...
messbaren Ergebnissen zu einer <span class="c-ref" data-ref-source-id="28" data-ref-type="ref" data-ref-desc="">generellen Tendenz</span> und schwächt somit
den
...
das Verknüpfen von Fakten und wissenschaftlicher Fiktion, seiner Job-Position und das eigene Engagement (Co-Founder der global agierenden Singularity
University) wirkt er jedoch
authentisch und überzeugend.</p>
      <p class="o-p--tie">Steven Pinker, kanadischer Kognitionswissenschaftler und Professor für Psychologie an der Harvard University (Cambridge,
Massachusetts) beschreibt die Situation
wie folgt:</p>
...
all your problems. (...)</p>
        <cite><span class="c-ref" data-ref-source-id="189" data-ref-type="zitat" data-ref-desc="">Steven Pinker</span></cite>
      </blockquote>
...
prognostizierte Kurzweil noch, dass die Singularität 2025 eintreffen <span class="c-ref" data-ref-source-id="12" data-ref-type="ref"
data-ref-hide-kneenote>würde.</span>
...
<abbr title="Technologische Singularität">TS</abbr> eintrete. Dabei wird der Vergleich nahegelegt, dass eine vermehrte Anzahl an Klingen nicht zwangsweise zu
einer verbesserten
...
Diskussionsteilnehmern um hochdekorierte Wissenschaftler und Experten, der letzten Dekaden. Das Niveau der Diskussion ist dementsprechend, trotz solcher
Trivia,
...
sich entweder sehr vage oder endgültig. Exzessiven Kritikern kann höchstenfalls mangelhaftes Vorstellungsvermögen unterstellt werden, da Kurzweils
experimentelle
Ansichten eine bestimmte Affinität und Imagination bezüglich futuristischer Vorstellungen implizieren.</p>
      <p class="o-p--tie">Erfindungen aus Steven Pinkers Antithese, wie beispielsweise das Reisen mithilfe von Jetpacks (Raketenrucksack), Unterwasserstädte
oder atombetriebene
...
zu beschleunigen.</p>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="32" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>

      <p>Die zeitweilig <span class="c-ref" data-ref-source-id="33" data-ref-type="ref" data-ref-desc="">stagnierende Entwicklung</span> im Forschungsgebiet
der
künstlichen Intelligenz kann ebenfalls als Kritik der Theorie angesehen werden. In
...
overstatements of theoretical computer power has been a humiliating and unending sequence of disappointments in the performance of real information
systems.</p>
...
data-ref-hide-kneenote>Person</span>).</p>
      <p class="o-p--tie">Die Kritik an den AI (Artificial Intelligence, z.d. künstliche Intelligenz) Entwicklungen relativiert sich durch die Erfolge der
...
Denken nachempfunden werden (Nutzung neuronaler Netzwerke).</p>
      ...
      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/lanier.png" alt="Jaron Lanier"
data-source="https://publishingperspectives.com/wp-content/uploads/2010/11/JARON_LANIER_01.jpg"/>
        </div>
...
society and our lives. If that happens, the ideology of cybernetic totalist intellectuals will be amplified from novelty into a force that could cause
suffering
for
millions of people.</p>
            <cite><span class="c-ref" data-ref-source-id="41" data-ref-type="zitat" data-ref-desc="">Jaron Lanier</span></cite>
          </blockquote>
...
diese radikalen Vertreter der <abbr title="Technologische Singularität">TS</abbr>. Lanier beschreibt sich selbst als ebenso enthusiastisch in Bezug auf
Technologie und Fortschritt kritisiert jedoch das
fehlende Verständnis von wissenschaftlicher Skepsis. Bostrom kritisiert primär die unzureichende bzw. fehlende Reflektion der etwaigen o.g. dystopischen
...
Selbstidentifikation genutzt werden können:</p>
      ...
      <blockquote>
        <ol>
          ...
          <li>That what Darwin described in biology, or something like it, is in fact also the singular, superior description of all creativity and
culture.</li>
...
the way we think about AI is colored by popular culture. There’s a distinction, which is probably familiar to a lot of your readers, between generalized AI and
specialized AI. In science fiction, what you hear about is generalized AI, right? Computers start getting smarter than we are and eventually conclude that
we’re
not all that useful, and then either they’re drugging us to keep us fat and happy or we’re in the Matrix. My impression, based on talking to my top science
advisers, is that we’re still a reasonably long way away from that. It’s worth thinking about because it stretches our imaginations and gets us thinking about
the issues of choice and free will that actually do have some significant applications for specialized AI, which is about using algorithms and computers to
figure out increasingly complex tasks. We’ve been seeing specialized AI in every aspect of our lives, from medicine and transportation to how electricity is
distributed, and it promises to create a vastly more productive and efficient economy. If properly harnessed, it can generate enormous prosperity and
opportunity. But it also has some downsides that we’re gonna have to figure out in terms of not eliminating jobs. It could increase inequality. It could
suppress wages.</p>
...
Machines Outsmart Humans“</span> oder Stiftungen wie <span class="c-ref" data-ref-source-id="44" data-ref-type="ref" data-ref-hide-kneenote>“Future of
Life“</span>
und dessen <span class="c-ref" data-ref-source-id="44" data-ref-type="bsp" data-ref-desc="">offener Brief</span>, mit prominenten Befürwortern, wie unter
anderem
...
commercial, technological, scientific and environmental issues that humanity will confront in this century.</p>
      ...
      <h2 id="der-aufstieg-von-softwares-und-deren-pioniere">Der Aufstieg von Softwares und deren Pioniere</h2>
...
und Verknüpfung diverser Themenbereiche mit unterschiedlicher und unregelmäßiger Geschwindigkeit zu sein. Dass vereinzelte Durchbrüche jedoch zwangsweise zu
einem
...
Transhumanismus oder die Robotik, welche in direkter Korrelation zu Entwicklungen im Hard- sowie Softwarebereich stehen, eine entscheidende Rolle spielen
können,
...
unzählige, wichtige Fortschritte zu verzeichnen hat.</p>
      ...
      <p><span class="c-ref" data-ref-source-id="5" data-ref-type="ref" data-ref-desc="" data-ref-hide-kneenote>The New Media Reader</span>, zusammengetragen
von Noah
Wardrip-Fruin und Nick Montfort, gilt als eine der ersten, erfolgreichen Bemühungen, die
historischen Ereignisse von Computer- und Software Technologien <span class="c-ref" data-ref-source-id="5" data-ref-desc="Inventing the medium – Janet H.
Murray, S.3"
...
rezitiert, welche speziell für die Entwicklung und die Digitalisierung durch Software entscheidende Meilensteine markieren.</p>
      ...
      <h3 id="digitale-rechenmaschinen">Digitale Rechenmaschinen</h3>
...
presumably, sex. There were many young ladies around, but I was too shy and too busy...</p>
        <cite><span class="c-ref" data-ref-source-id="47" data-ref-type="zitat" data-ref-desc="Banks: What was the intellectual and social life like at
Bletchley Park?
- S.10 ">Irving John Good</span></cite>
      </blockquote>
...
data-source="https://www.welt.de/img/kultur/literarischewelt/mobile133890343/0182502307-ci102l-w1024/A-handout-photo-shows-Alan-Turing-1912.jpg"/>
        ...
        <div class="c-person__content">
          ...
          <p class="c-person__bio">Der englische Wissenschaftler Alan Mathison Turing ist neben seinen Leistungen als Logiker, Kryptoanalytiker und
theoretischer
...
Difference- bzw. <span class="c-ref" data-ref-source-id="50" data-ref-desc="" data-ref-type="ref" data-ref-hide-kneenote>Analyticalengine.</span> Das
Revolutionäre an
...
Neumanns Verdienste besonders auf der Mathematisierung und Verwissenschaftlichung selbiger. Initial sollten die Ergebnisse in der <abbr title="Electronic
Numerical Integrator and Computer">ENIAC</abbr> Arbeitsgruppe intern
...
welche sich in ihrer Funktionsweise und Zusammenspiel in zeitgeistigen Computersystemen weitestgehend <span class="c-ref" data-ref-source-id="194"
...
<table>
  <caption class="o-h5">
    <span class="c-ref" data-ref-source-id="196" data-ref-desc="Eigenschaften der ersten Computer" data-ref-type="ref">Eigenschaften der ersten Computer</span>
  </caption>
  <thead>
    <tr>
      <th>Computer</th>
...
die Art und Weise mit der sich die Wissenschaftler noch vor dem Zeitalter der Globalisierung und den Vernetzungsmöglichkeiten des Internets international
verständigen, um ihre Forschungen und Maschinen zu optimieren, ist eine auffallende Beobachtung.</p>
          ...
          <span class="c-notes-side">
            ...
            <span class="c-note-side">
              <span class="c-note-side__content">
                ...
                <span class="c-note-side__text">Die <span class="c-ref" data-ref-source-id="55" data-ref-desc="" data-ref-type="ref">Studienarbeit</span> von
Marcus
Richter und Constanze Kurz ist für den tieferen Einblick in die mögliche
Motivation Neumanns empfehlenswert. Ebenfalls die Aussagen von Neumanns Tochter in der Arte Dokumentation über sein <span class="c-ref"
data-ref-source-id="194"
data-ref-desc="" data-ref-parameter="&t=22m53s" data-ref-type="ref">Lebenswerk.</span></span>
              </span>
            </span>
          </span>
        </span>
      ...
      <blockquote>
        ...
        <cite><span class="c-ref" data-ref-source-id="198" data-ref-type="zitat" data-ref-desc="">Oppenheimer zu Präsident Truman</span></cite>
      </blockquote>

      <blockquote>
        <p>Nun bin ich der Tod geworden, der Zerstörer der Welt.</p>
        <cite><span class="c-ref" data-ref-source-id="199" data-ref-type="zitat" data-ref-desc="S.682 ">Oppenheimer zitiert bedauernd das hinduistische Werk
Bhagawadgita</span></cite>
      </blockquote>
      ...
      <p>Schlussendlich markieren die Studien von Turing, Neumann und weitere Wissenschaftler Meilensteine in der Entwicklung. Sie zeigen jedoch auch auf, dass
eine reflektierte
...
digitalen Rechenmaschinen betrieben werden können.</p>
      ...
      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/sutherland.png" alt="Ivan Sutherland"
data-source="http://www.roadtovr.com/fred-brooks-ivan-sutherlands-1965-ultimate-display-speech/"/>
        </div>
        <div class="c-person__content">
          <h4 class="c-person__name">Ivan Sutherland</h4>
          <p class="c-person__bio">Einer ihrer Entwickler ist der amerikanische <abbr title="Massachusetts Institute of Technology">MIT</abbr> Doktorand Ivan
Sutherland, welcher bis heute als Spezialist und Pionier im
...
Grafikanwendungen für die <span class="c-ref" data-ref-source-id="6" data-ref-desc="S.109" data-ref-type="vgl">militärische Radarentwicklung.</span> Sutherland
ist
...
weiterer grafikbezogener Algorithmen.</p>
      ...
      <p>Die unter dem Namen <span class="c-ref" data-ref-source-id="6" data-ref-desc="Sketchpad: A Man-Machine Graphical Communication System – Ivan
Sutherland, 1963
...
unmittelbaren Manipulation von Objekten, basierend auf Vektoren (Punkte, Linien, Formen). Es ist somit das erste sog. <span class="c-ref"
data-ref-source-id="6"
...
Verbindungsprozess von <span class="c-ref" data-ref-source-id="6" data-ref-desc="S.111" data-ref-type="vgl">Kalkulation und Design</span>, zu denen speziell
heutige
Designer und gleichermaßen Developer (Entwickler) in Schnittstellenpositionen – welche
Technologien/Tools (Werkzeuge), wie z.B. generatives Design oder <abbr title="Syntactically Awesome Stylesheets">SASS</abbr> nutzen – einen besonderen <span
class="c-ref" data-ref-source-id="59" data-ref-desc=""
...
Sutherlands Arbeit an Sketchpad beeinflusst in den folgenden Jahren weitere Pioniere, wie Alan Kay beim Etablieren der objektorientierten Programmierung oder
der
...
Maßstab und ist in der Regel ein Synonym für den allgemeineren Begriff, Personal Computer oder PC, ein Computer für eine Person
entworfen.">Mikrocomputern.</abbr></p>
...
allowfullscreen></iframe>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="201" data-ref-type="ref" data-ref-desc="" data-ref-parameter="?t=3m30s" data-ref-hide></span><!-- old time
?start=212
-->
        </div>
      </div>
...
ausgelegt, möglichst komplexe Berechnungen zu bewältigen. Großrechner dagegen sind für das stabile, gleichzeitige und kontinuierliche Bewältigen von großen
Datenmengen zuständig. Unabhängig
zu welchem Anwendungszweck Supercomputer oder Mainframes genutzt werden, benötigen beide Systeme Ressourcen, welche nur von großen Unternehmen finanziert
werden
...
möglichst hohen Gewinn zu erzielen. Für dieses Vorhaben nutzt Fink das Datenanalysesystem von Hallac.</p>
      ...
      <p>Das aus Algorithmen bestehende System <abbr title="Asset, Liability, and Debt and Derivative Investment Network">Aladdin</abbr> bildet das Fundament
seines, im selben
...
Ausnutzung dieser Parameter. Gleichzeitig ist es Auktionär in einer <span class="c-ref" data-ref-source-id="63" data-ref-desc="S.1"
data-ref-type="vgl">Unsumme</span> einflussreicher Aktienunternehmen weltweit. Neben dem datierten Eigenwert des
Unternehmens, handelt es mit Liquiditäten zwischen <span class="c-ref" data-ref-source-id="64" data-ref-desc="" data-ref-type="ref">4-5 Billionen US
Dollar</span>. Im Vergleich liegt das weltweite Bruttosozialprodukt zwischen <span class="c-ref" data-ref-source-id="65" data-ref-desc=""
data-ref-type="ref">50-60 Billionen US Dollar.</span>
Zusammengefasst handelt es sich bei BlackRock und verknüpften Firmen, um einen mächtigen und global agierenden Unternehmensapperat, welcher ebenfalls in
popkulturellen Werken, wie
beispielsweise dem Film <span class="c-ref" data-ref-source-id="67" data-ref-desc="" data-ref-type="ref" data-ref-hide-kneenote>Fight Club</span> oder der TV
Sendung <span class="c-ref" data-ref-source-id="66" data-ref-desc="" data-ref-type="ref" data-ref-hide-kneenote>Mr. Robot</span> thematisiert wird.
...
Büro des Unternehmens zwischen einem Kühlschrank und einer <span class="c-ref" data-ref-source-id="61" data-ref-desc=""
data-ref-type="ref">Kaffeemaschine</span>. Heute verteilt sich Aladdin auf vier leistungsstarke sowie autarke Rechenzentren. Die
...
Risikoinvestments BlackRocks sowie vernetzter Partnerunternehmen und Kunden. Zu BlackRocks Kunden und anteiligen Firmen zählen nicht nur die Großzahl der
einflussreichsten globalen Unternehmen, sondern beispielsweise ebenfalls die <span class="c-ref" data-ref-source-id="304" data-ref-desc=""
data-ref-type="ref">US Regierung.</span> Zusätzlich werden nicht nur Informationen aus dem Finanzsektor
...
Datensätzen im Zeitalter des Internets verdeutlicht sich das Ausmaß dieser Reichweite. Die Korrelationen der Daten wertet Aladdin aus, um Risikoprognosen und
Empfehlungen zu erstellen, welche BlackRock wiederum nutzt und anschließend neue Werte zurückspeist. Solche enormen Rechenoperationen können nur mithilfe eines
...
computer will gain information superiority. People are created equal, but computers are not.</p>
      ...
      <p class="o-p--note">In diesem Vergleich kann nachvollzogen werden wie präzise Sam Ismael und sein Team die Werbemittel von realen Unternehmen wie
BlackRock – welche oftmals aus gekauftem Stock Material zusammengeschnitten werden – adaptieren, um die fiktionale Firma E Corp in Mr. Robot zu
portraitieren.</p>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="69" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="68" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>
...
traditionellen Machtstrukturen nun ebenfalls auf außerordentlichen Mengen von <span class="c-ref" data-ref-source-id="75" data-ref-desc=""
data-ref-type="bsp">Daten und Rechenleistungen</span>. In einer technologisch beschleunigten Gesellschaft ist es
...
Die Schwierigkeiten bestehen primär in der Identifikation, dem Verständnis und den undurchsichtigen Auswirkungen dieser komplexen Strukturen. Ironischerweise
spiegeln sich visualisierte Beispiele in zeitgeistigen Computerspielen wider, in denen neue Schnittstellen und neue Möglichkeiten, wie Virtual Reality, in
Zukunft denkbar positive Ansätze zur Transparenz solcher Datenströme darstellen können.</p>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="202" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="76" data-ref-type="bsp" data-ref-desc="" data-ref-hide></span>
        </div>
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="77" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>
      ...
      <h3 id="medien-fuer-die-massen">Medien für die Massen</h3>

      <blockquote>
        <p>There is no reason for any individual to have a computer in his home.</p>
        <cite><span class="c-ref" data-ref-source-id="79" data-ref-desc="" data-ref-type="zitat" data-ref-hide-kneenote>Ken Olson</span></cite>
      </blockquote>

      <p>Mit seiner populären Aussage in den 70er Jahren wird Ken Olson oft als Paradebeispiel einer fatalen Fehlprognose rezitiert. Dabei wird seine Aussage
...
Haushalts etabliert, sondern dass Computer alle Aspekte des Lebens regulieren würden wie in mancher Science Fiction Vision.</p>
      ...
      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/olsen.png" alt="Ken Olsen"
data-source="http://www.metrowestdailynews.com/article/20110208/NEWS/302089151"/>
        </div>
        <div class="c-person__content">
          <h4 class="c-person__name"><span class="c-ref" data-ref-source-id="72" data-ref-desc="" data-ref-type="ref" data-ref-hide-kneenote>Ken
Olsen</span></h4>
...
Corporation (DEC) gründete. Bis 1992 war er Präsident des Unternehmens. Olsen war ebenfalls einer der <abbr title="Massachusetts Institute of
Technology">MIT</abbr> Ingenieure der TX Computer Serie, welche beispielsweise
als Hardware Grundlage für Sketchpad fungiert (TX-2).</p>
        </div>
      </div>

      <blockquote>
        <p>This [the quoted comment in Time magazine] is, of course, ridiculous because the business we were in was making PCs, and almost from the start I had
them at home…</p>
        <p>What Olsen focuses on retrospectively is that in the 1950s and 1960s there existed the notion that the computer not only could but would control all
aspects of our lives. Images of the fully computerized home that automatically turned lights on and off and that prepared meals and controlled daily diets were
...
everything. Why would anyone want that?</p>
        <cite><span class="c-ref" data-ref-source-id="80" data-ref-desc="" data-ref-type="zitat" data-ref-hide-kneenote>Edgar H. Schein in Konversation mit
Olsen</span></cite>
      </blockquote>

      <p>Werden diese historischen Betrachtungsweisen auf zeitgeistige Entwicklungen von Cloud Computing, Smart Homes, AI und den anhaltenden Diskurs über
...
zukünftigen Entwicklungen von Technologien. Zum anderen die kontinuierlich stärker eingreifende Verankerung von Technologien in den Alltag und der unveränderte
Gegenstand des Diskurses in der Akzeptanz technologischer Entwicklungen. In Anbetracht aktueller Entwicklungen erweist sich Olsens Prognose, selbst nach
...
Etablieren des Personal-/Mikro- bzw. Home Computers. Zwischen den 70er und 80er Jahren beginnt die sich rapide ausweitende und umgreifende Serienproduktion,
welche die Veränderungen des Alltags für die nächsten Dekaden <span class="c-ref" data-ref-source-id="81" data-ref-desc=""
data-ref-type="ref">einleiten.</span></p>

      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/manovich.png" alt="Lev Manovich" data-source="http://manovich.net/index.php/about"/>
        </div>
        <div class="c-person__content">
          <h4 class="c-person__name"><span class="c-ref" data-ref-source-id="82" data-ref-desc="" data-ref-type="ref" data-ref-hide-kneenote>Lev
Manovich</span></h4>
...
gilt <span class="c-ref" data-ref-source-id="4" data-ref-desc="S.39" data-ref-type="vgl">Lev Manovich.</span> Mit seinem Hintergrund als angewandter
Computerwissenschaftler, Künstler, lehrender Professor und seiner persönlichen Herkunft aus
russisch-amerikanischen Verhältnissen, gilt Manovich unter anderem als Experte im Bereich umfassender Medientheorie/-historie. In seiner Funktion als
Medienkritiker, -künstler und -theoretiker rezitiert er in seinen Werken nicht nur Mediengeschichte, sondern setzt sich konkret mit der Wechselwirkung dieser
und der in direktem Kontext einhergehenden, gesellschaftlichen Entwicklung auseinander. Dabei beschreibt er bedeutende Paradigmenwechsel und zeigt, wie sich
die
Gesellschaft, speziell beim schaffenden Prozess im Umgang mit sog. <abbr title="Engl. New Media">„Neuen Medien“</abbr> im stetigen Wandel befindet.</p>
        </div>
      </div>
...
Facebook.</li>
      ...
      <p>Manovich erläutert jeden dieser Punkte ausführlich in seinem Werk „Software takes Control“, in dem auch das Thema Internet eine essentielle Rolle
einnimmt.
...
Adobe Illustrator. Diese tauchen vergleichsweise früh in der Computerhistorie auf, bieten einen angemessenen Komplexitätsgrad, sind während der gesamten
...
dem
ersten in <span class="c-ref" data-ref-source-id="84" data-ref-desc="" data-ref-type="ref">größerer Serie</span> gefertigten Mikrocomputer mit grafischer
...
Dezember 2005), stetig mit neuen Funktionen erweitert; sowohl in den Aspekten der Bedienbarkeit als auch in der Performance. Durch die Entwicklung diverser
Grafiksoftware, der engen Zusammenarbeit mit weiteren erfolgreichen Unternehmen, wie z.B. Apple und der Verknüpfung interner, inzwischen etablierter,
fortschrittlicher Formate, profitieren alle Adobe Produkte in ihrer Entwicklung <span class="c-ref" data-ref-source-id="4" data-ref-desc="S.305"
data-ref-type="vgl">voneinander.</span></p>
...
entschließt sich Adobe seine Dienste als Cloud Software anzubieten und den Verkauf und Support von „Standalone“ Versionen nach und nach einzustellen.
Inzwischen
...
Ressourcen extern hinzuzufügen.</p>
      <p class="o-p--tie">Das im Dezember 2016, als Betaversion erschienene <span class="c-ref" data-ref-source-id="86" data-ref-desc=""
data-ref-type="ref">Adobe Experience Design</span> ermöglicht es Designern „Mock-Up Layouts“ für digitale
Interaktion Produkte zu entwickeln, ohne weitreichende Programmierkenntnisse zu besitzen. Die Entwicklung solcher Software zeigt sowohl die Vernetzung
erarbeiteter Funktionalitäten diverser Programme auf, als auch die Nachfrage für simplifizierte Kollaborationsmöglichkeiten verschiedener Anwenderzielgruppen
...
Softwarebranche auf. Sie repräsentiert allerdings einige der wichtigsten Erfolgsfaktoren von Software im Allgemeinen und gilt damit als einer der
exemplarischen
Stellvertreter für die Auswirkungen auf gesellschaftliche Paradigmen, speziell zu Zeiten der ersten Mikrocomputer.</p>
      <p class="o-p--tie">Einer dieser Erfolgsfaktoren besteht in der, an die <span class="c-ref" data-ref-source-id="87" data-ref-desc=""
data-ref-type="ref">Semiotik</span> angelehnte Nutzung von grafischen Benutzeroberflächen (GUI – graphical
...
ermöglichen die simplifizierte Interaktion, sowohl zwischen dem Medium und kreativer Individuen, als auch untereinander – z.B. Software <abbr
title="Entwickler">Developer</abbr> und Designer
...
Sie stellen einer der Hauptgründe dafür dar, dass viele Aspekte und Abläufe von Software sich zunehmend im menschlichen Alltag verankern, sodass sie als
...
Charaktereigenschaften weiterhin, häufig ein unsichtbares Medium.</p>
...
evolution und deep remix widerspiegeln. Sie beziehen sich besonders auf die zweite Hälfte der 90er Jahre, in denen die Entwicklung von Hard- und Software
...
Anwendungsgebieten auf das Konzept von Medien <span class="c-ref" data-ref-source-id="4" data-ref-desc="S.46" data-ref-type="vgl">auswirken.</span></p>
...
semiosis and human communication, enabled by its „softwarization.“</p>
        <cite><span class="c-ref" data-ref-source-id="4" data-ref-desc="S.46" data-ref-type="zitat" data-ref-hide-kneenote>Lev Manovich</span></cite>
      </blockquote>
...
möglich,
um völlig neue Medien zu kreieren. Insbesondere diese Beobachtungen und Eigenschaften von Software begünstigen beziehungsweise manifestieren sich in
nachfolgenden Entwicklungen, wie der Einführung des Smartphones oder in der Entstehung des <span class="c-ref" data-ref-source-id="4" data-ref-desc="S.46"
data-ref-type="vgl">Internets.</span></p>

      <a href="http://bestreviews.com/#reviews" target="tab"><img src="./assets/img/evolutionofdesk.jpg" alt=""/></a>
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="204" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
        <div class="c-notes-marginal__item">
...
for many new media combinations.</p>
        <cite><span class="c-ref" data-ref-source-id="4" data-ref-desc="S.330" data-ref-type="zitat" data-ref-hide-kneenote>Lev Manovich</span></cite>
      </blockquote>
...
Werke adaptiert. Sie entwickeln sich besonders seit der Einführung des Internets auf progressive Weise, indem sie neue Funktionalitäten während ihrer Nutzung
hinzufügen. Ein aktuelleres Beispiel dafür ist die <span class="c-ref" data-ref-source-id="89" data-ref-desc="" data-ref-type="ref">Erweiterung</span> des
“Gefällt mir“ Buttons von Facebook.</p>
      <p class="o-p--tie">Die wichtigsten Merkmale des meta-medialen Zeitalters offenbaren sich durch die starke Vernetzung diverser Medien der o.g.
progressiven Weiterentwicklung durch übergreifende sowie gegenseitige Inspiration (Imitation und Kollaboration) oder der Überholung von klassischen Medien.
Darunter fallen z.B. die Weiterentwicklung des klassischen Fernsehprogramms in on-demand Services, die Evolution des Haustelefons zu Mobilgeräten, die
Verdrängung des Telefonbuchs durch deren Integration in Smartphones und weitere vergleichbare Entwicklungen.
Nachhaltig <span class="c-ref" data-ref-source-id="4" data-ref-desc="S.329" data-ref-type="vgl">ermöglicht</span>, beschleunigt und erhöht sich dadurch die
Erfindung und Kreuzung neuer Technologien/Medien besonders, weil ein Großteil dieser auf
Software basiert. Auffallend ist die Kleinteiligkeit in der die verschiedenen Bereiche Erfolge erzielen. Diese wiederum treiben den Vormarsch der digitalen
Revolution in seiner Gesamtheit an.</p>
      <p class="o-p--tie">Das gesamte Konstrukt von Software, Meta Medien und Vernetzung im 21. Jahrhundert ist damit geprägt von natürlichen, organischen
Prozessen, obwohl diese weitgehend artifiziell initiiert wurden.</p>

      <h3 id="digitale-mobilitaet">Digitale Mobilität</h3>

      <p>Viele gedankliche Impulse, welche sich Jahre später als die Bausteine von entscheidenden Durchbrüchen in der Softwarehistorie herausstellen, wie
beispielsweise das Konzept des <span class="c-ref" data-ref-source-id="4" data-ref-desc="S.44" data-ref-type="vgl">Meta Mediums</span>, stammen <span
class="c-ref" data-ref-source-id="4" data-ref-desc="S.329" data-ref-type="vgl">ursprünglich von Alan Kay.</span></p>

      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/kay.png" alt="Alan Kay"
data-source="http://afflictor.com/wp-content/uploads/2011/02/Alan_Kay_and_the_prototype_of_Dynabook_pt._5_3010032738.jpg.jpeg"
data-article="http://afflictor.com/2011/02/24/alan-kay-designed-the-computer-tablet-in-1968/"/>
        </div>
        <div class="c-person__content">
          <h4 class="c-person__name">Alan Kay</h4>
          <p class="c-person__bio">Als <i>die</i> universelle Schlüsselfigur der Softwareentwicklung im Kontext dieser Arbeit kann zweifelsohne der
...
wie z.B. Manovich zur Auseinandersetzung mit Software und Medien sowie deren Entwicklung und potentialerfüllten Einfluss.</p>
      ...
      <p>Während die Computerszene Mitte der 70er Jahre ihren Aufschwung erlebt, veröffentlichen Alan Kay und Adele Goldberg ihre Vision des sog. „Dynabooks“ -
das detailierte Konzept eines mobilen, handlichen, personalisierten Computers für jede Art von Endnutzer. Bis zu diesem Zeitpunkt erscheinen ähnlich
revolutionäre Konzepte nur in Veröffentlichungen der Science Fiction. Neben dem technisch versierten Teil des Konzepts gilt insbesondere die angedachte Nutzung
für kreative Prozesse als außergewöhnlich. Kay und Goldbergs Anliegen, die Benutzeroberfläche als Hilfsmittel für jede Person, sogar Kinder,
zugänglich zu machen, revolutioniert den Umgang und die Sicht mit und auf Software nachhaltig. Durch ihre vorausschauende Sichtweise initiieren sie die
Grundlagen für personalisierte, softwaregesteuerte Devices.</p>

      <img src="./assets/img/dynabook.png" alt="Mock-up of a future Dynabook"/>

      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="5" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>
      ...
      <blockquote>
        <p>The arcane aura that surrounds personal computers is not just a "user interface" problem. My colleagues and I at <abbr title="Palo Alto Research
Center">PARC</abbr> think that the idea of a
"personal" computer itself is misplaced, and that the vision of laptop machines, dynabooks and "knowledge navigators" is only a transitional step toward
...
allows the computers themselves to vanish into the background.</p>
        <cite><span class="c-ref" data-ref-source-id="90" data-ref-desc="" data-ref-type="zitat" data-ref-hide-kneenote>Mark Weiser</span></cite>
      </blockquote>

      <p>Der Wissenschaftler Mark Weiser, ebenfalls bei Xerox <abbr title="Palo Alto Research Center">PARC</abbr>  in leitender Position beschäftigt,
veröffentlicht 1991 ein noch <span class="c-ref" data-ref-source-id="90" data-ref-desc="" data-ref-type="ref">präziseres Dokument</span> mit den
Vorstellungen des <abbr title="Palo Alto Research Center">PARC</abbr> Teams. In der Abhandlung wird das sog. Ubiquitous Computing beschrieben, welches Ansätze
wie das „Dynabook“ nur als eine Transition
innerhalb der Medien begreift. In Zukunft soll der klassische Rechner eine Omnipräsenz im Alltag erreichen, indem er sich dezentralisiert in
Alltagsgegenständen
manifestiert. 1999 knüpft Kevin Ashton mit seiner Veröffentlichung „Internet of Things“ an dieses Konzept an. Der Grundgedanke bezieht sich dabei auf die
Entlastung des Menschen, damit sich dieser auf essentielle Abläufe fokussieren kann. Erfindungen wie beispielsweise Smartwatches oder die Paketverfolgung im
Postversand verdeutlichen die Präsenz dieser Ansätze im gegenwärtigen Geschehen.</p>
      <p class="o-p--tie">Weitere der Xerox <abbr title="Palo Alto Research Center">PARC</abbr> Projekte leisten Pionierarbeit für zukünftige Entwicklungen und
den daraus
...
Unternehmen wie Apple und Microsoft bedienen sich erfolgreich des GUI Erfolgskonzepts, durch die von Xerox selbstgewährte direkte Einsicht in
deren
...
gründet oder Robert Metcalfe, welcher das Ethernet entwickelt und in seiner eigenen Firma 3Com kommerziell nutzt, das Potential in den <span class="c-ref"
data-ref-source-id="208" data-ref-desc="" data-ref-type="ref">Entwicklungen</span> von Xerox
auf.</p>
...
zugehöriger Wissenschaftler. Diese Veränderungen verdeutlichen zuletzt erneut und unmissverständlich die Vernetzung zwischen Mensch und Maschine sowie das
anhaltende Interesse an stetig verfügbaren technischen Hilfsmitteln.</p>

      <a href="https://www.instagram.com/p/W2BuMLQLRB/" target="tab"><img src="./assets/img/beforeandaftersmartphones.jpg" alt="Vor und nach den Entwicklungen
der Smart Ära"/></a>
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="91" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>

      <p>Die detaillierte Untersuchung dieses Paradigmenwechsels und dessen soziokulturelle Phänomene haben den ausreichenden Umfang für eine eigenständige
Auseinandersetzung und würden die Rahmenbedingungen dieser Arbeit überschreiten. Die jedoch wichtigsten Erkenntnisse spiegeln sich in den Erfolgsfaktoren und
Entwicklungshistorie der Smartphone und Tablet Industrie wider. Während für die Evolution des Computers (~1970-1990) die Diversität innovativer Konzepte
eine primäre Position einnehmen, so stellen die hybridization und der deep remix nach Manovich, für die letzten einschlägigen und vor allem digitalen Produkte
der Computerindustrie, priorisierte Entitäten dar. Das Zusammenführen von Experten diverser Branchen, die schnelle Adaption von (Software-)Funktionalitäten
erfolgreicher Konkurrenzprodukte und die Nutzung sowie Vernetzung verschiedener Medien, zeichnet die Entwicklung der digitalen Produkte des 21. Jahrhunderts
aus. Eine verstärkte Nutzung von Gestaltungsgrundlagen sowie die Lehren und Erfahrungen aus der Mensch-Computer-Interaktion (z.B. nach <span class="c-ref"
data-ref-source-id="92" data-ref-desc="" data-ref-type="ref" data-ref-hide-footnote>Donald Norman)</span> führen zu
einer Vielzahl erfolgreicher Produkte.</p>

      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/jobs.png" alt="Steve Jobs"
data-source="https://www.technobezz.com/files/uploads/2015/10/stevejobs1.jpg"
data-article="https://www.technobezz.com/watch-the-animated-biography-of-steve-jobs/"/>
        </div>
        <div class="c-person__content">
          <h4 class="c-person__name"><span class="c-ref" data-ref-source-id="209" data-ref-desc="" data-ref-type="ref" data-ref-hide-kneenote>Steve
Jobs</span></h4>
          <p class="c-person__bio">Steve Jobs gilt als das Paradebeispiel für die Initiierung dieser technologisch geprägten, popkulturellen Epoche. Als
Gründer
...
das Gespür für die Gestaltung in aktuelleren Produkten verloren.</p>
        </div>
      </div>
...
und
die jeweilige Anwendung angepasst wird und eine adäquate Interaktion mit der zugehörigen Hardware ermöglicht. So fungieren Desktop Rechner und Laptops als
universeller Editor für digitale Inhalte, das Smartphone primär als mobiles Konsummedium und Smart Devices als Hilfsmittel für die spezifische Augmentation der
jeweiligen Tätigkeit (z.B. Smartdevices als Jogging Trainer).</p>
      <p class="o-p--tie">Seit der Einführung des Smartphones besteht ein steigendes Interesse an jenen und vergleichbaren Devices, wie beispielsweise
Smartwatches. Durch das Angebot und den Absatz dieser Geräte zeichnet sich eine Nachfrage nach intelligenten und kulturellen Alltagsgeräten ab. Die Koexistenz
dieser verschiedenen <span class="c-ref" data-ref-source-id="96" data-ref-desc="" data-ref-type="ref">“Smart Devices“</span> begründet sich durch ihre
unterschiedlichen Anwendungszwecke und Usability Eigenschaften. Das Smartphone fungiert, aufgrund
seiner universellen Funktionsweise, aktuell als prominentester, zentraler, gesellschaftlicher Minimalkonsens für die mobile Augmentation des alltäglichen
Geschehens.</p>
...
Desktop-Computern oder sich bestimmte Theorien, wie beispielsweise Internet der Dinge, vollständig bewahrheiten, bleibt zunächst <span class="c-ref"
data-ref-source-id="97" data-ref-type="bsp" data-ref-desc="" data-ref-hide>spekulativ</span>. In einer möglichen
Post Smartphone Ära müsste das jeweilige Gerät die Eigenschaften des Smartphones zunächst erfüllen bzw. übertreffen und sich kulturell etablieren – zudem
nutzen
...
Zukunft, aufgrund ihrer einzigartigen Eigenschaften, die Schnittstellen des digitalen Zeitalters und ggf. darüber hinaus präsent. Dies zeigt sich
beispielsweise
in Produkten wie Spectacles von Snap Inc.</p>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="97" data-ref-type="bsp" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>

      <p>Die Kritik von Hartmut Esslinger an Apple gilt als berechtigt, da Apple nach dem Tablet vergleichsweise keine bahnbrechende
Technologien präsentiert und sich Konkurenzunternehmen inzwischen auf einem ähnlichen Niveau befinden. Allerdings ermöglichen und vereinfachen Apple sowie
vergleichbare Unternehmen mit der Implementierung neuer Mediageräte (Smartphones, Tablets, etc.) den Zugang für <abbr
title="Entwickler">Developer</abbr> und Designer, sich aktiv an aktuellen
Trendentwicklung zu beteiligen und diese <span class="c-ref" data-ref-source-id="98" data-ref-desc="" data-ref-type="ref">mitzugestalten.</span><span
class="c-ref" data-ref-source-id="99" data-ref-desc="" data-ref-type="ref"></span></p>
...
der techno-kulturellen Veränderungen berechenbarer geworden und basieren nun verstärkt auf bereits geleisteten Gedankengängen oder bestehenden Konzepten, indem
...
Evolution zur Hybridization. Somit ist Esslingers Kritik, abgesehen von der direkten Kritik an Apple Produkten evtl. eine zeitgeistige
Beobachtung, welche weitreichender bzw. umfassender zu verstehen ist.</p>

      <h3 id="internet">Internet</h3>

      <p>Die globale Vernetzung durch die Technologien des Internets stellt sowohl die erste auf reiner Softwareebene agierende Revolution sowie die bis dato
massivste Veränderung gesellschaftlicher Normen dar. Sie betrifft nahezu jeden Themenbereich der menschlichen Kultur, während sie jene Bereiche ebenfalls
als angereicherte Information in digitaler Form enthält. Von den ersten rudimentären Anfängen in sog. <span class="c-ref" data-ref-source-id="211"
data-ref-desc="" data-ref-type="ref">Bulletin Board Systems (<abbr title="Bulletin Board System">BBS</abbr>)</span> und dem simplen Austausch
über E-Mails bis zu intelligenten Social Media Netzwerken, wie Facebook und der explosionsartigen Entstehung des heutigen App-Marktes, entwickelt sich das
Internet und seine angrenzenden Themenfelder, im Direktvergleich zu allen vorherigen Schöpfungen der Computer Evolution, so exponentiell beschleunigt, dass ein
umfassendes Verständnis der Korrelationen für gesellschaftliche Zusammenhänge sehr undurchsichtig erscheint. Um dennoch einen themenbezogenen Einblick der
...
Mediums, dessen Nutzer sowie des unmittelbaren Kontextes.</p>
      ...
      <p>Als eine der ersten populären virtuellen Online-Kommunen gilt <span class="c-ref" data-ref-source-id="212" data-ref-desc="" data-ref-type="ref">The
...
puristische Grundlage nachfolgender Kommunikations- und Social Media Plattformen wie beispielsweise IRC, Reddit oder Facebook.
        ...
        <span class="c-notes-side-hook">
          <span class="c-notes-side">
            ...
            <span class="c-note-side">
              <span class="c-note-side__content">
                <strong class="c-note-side__headline">Cyberspace</strong>
                <span class="c-note-side__text">„Cyberspace“ (englisch cyber als Kurzform für
                „Kybernetik“, space „Raum, Weltall“: kybernetischer Raum, Kyberraum) bezeichnet im engeren Sinne eine konkrete virtuelle Welt oder Realität
(„Scheinwelt“), im
                erweiterten Sinne die Gesamtheit mittels Computern erzeugter räumlich anmutender oder ausgestalteter Bedienungs-, Arbeits-, Kommunikations- und
Erlebnis
                Umgebungen. In der verallgemeinernden Bedeutung als Datenraum umfasst der „Cyberspace“ das ganze Internet. Die Sozialwissenschaften verstehen
den „Cyberspace“
      ...
      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/abene.jpg" alt="Mark Abene"
data-source="https://www.technobezz.com/files/uploads/2015/10/stevejobs1.jpg"
data-article="https://www.technobezz.com/watch-the-animated-biography-of-steve-jobs/"/>
        </div>
        <div class="c-person__content">
...
Deception (MoD) einer in New York ansässigen und prestigeträchtigsten Hacker Gruppierungen ihrer Zeit. Im sog. medienwirksamen Great Hacker War konkurriert
MoD
mit rivalisierenden Legion of Doom (LoD) Mitgliedern, welcher Elias Ladopoulos alias Acid Phreak angehört. Letztendlich wird diese Auseinandersetzung durch die
...
data-ref-parameter="&t=34m24s" data-ref-desc="" data-ref-type="ref" data-ref-hide-kneenote>Kodex</span> auf dessen Grundlagen später sog. white
hat-Hacker-Aktivitäten fußen. Diese basieren auf einem ethischen Verständnis ihrer Subkultur und kooperieren später häufig mit Unternehmen in sog.
penetration tests, um die Sicherheit von Computersystemen zu optimieren. Die Kontroverse um den Great Hacker War fundiert primär auf dem Eingriff
staatlicher Institutionen und konkreter werdenden Gesetzesentwürfen bezüglich Cyberkriminalität. Die Institutionen bewegen in diversen Fällen einzelne Hacker
dazu, gegen ihre Kollegen auszusagen, um der Strafverfolgung zu entgehen. Im späteren Verlauf resultieren daraus für viele Hacker, darunter Abene,
Gefängnisstrafen und leiten gekoppelt mit dem steigenden Alter und Interessensverlust der Protagonisten das Ende dieser Ära ein.</p>
        </div>
      </div>

      <p>In dem <abbr title="Bulletin Board System">BBS</abbr> „The WELL“ trifft die Generation von jugendlichen Hackern auf den Anhänger einer älteren
Generation der Hippiebewegung, <span class="c-ref" data-ref-source-id="101" data-ref-parameter="&t=10m39s" data-ref-type="ref">John Perry Barlow.</span>
Ironischerweise geraten die beiden Parteien, welche in ihrem Wesen eigentlich dieselben Grundprinzipien des wachsenden Internets vertreten, zu diesem Zeitpunkt
aneinander. Der liberal geprägte Barlow beschreibt dieses Aufeinandertreffen u.a. in seinem Artikel <span class="c-ref" data-ref-source-id="104"
data-ref-type="ref" data-ref-desc="">Crime and Puzzlement</span> folgendermaßen:</p>

      <p></p><!-- hotfix -->

      <div class="c-chat-log">
        <p><i>And I remembered Kevin Mitnik. Mitnik, now 25, recently served federal time for a variety of computer and telephone related crimes. Prior to
incarceration, Mitnik was, by all accounts, a dangerous guy with a computer. He disrupted phone company operations and arbitrarily disconnected the phones of
celebrities. Like the kid in Wargames, he broke into the North American Defense Command computer in Colorado Springs.</i></p>
        <p><i>Unlike the kid in Wargames, he is reputed to have made a practice of destroying and altering data. There is even the (perhaps apocryphal) story
that he altered the credit information of his probation officer and other enemies. Digital Equipment claimed that his depredations cost them more than $4
million in computer downtime and file rebuilding. Eventually, he was turned in by a friend who, after careful observation, had decided he was "a menace to
society."</i></p>
        <p><i>His spectre began to hang over the conference. After several days of strained diplomacy, the discussion settled into a moral debate on the ethics
of security and went critical.</i></p>
        <p><i>The techno-hippies were of the unanimous opinion that, in Dylan's words, one "must be honest to live outside the law." But these young strangers
apparently lived by no code save those with which they unlocked forbidden regions of the Net.</i></p>
        <p><i>They appeared to think that improperly secured systems deserved to be violated and, by extension, that unlocked houses ought to be robbed. This
latter built particular heat in me since I refuse, on philosophical grounds, to lock my house.</i></p>
        <p><i>Civility broke down. We began to see exchanges like:</i></p>
        <p class="c-chat-log__code">Dave Hughes: Clifford Stoll said a wise thing that no one has commented on. That networks are built on trust. If they
aren't, they should be.</p>
        ...
        <p class="c-chat-log__code">Jef Poskanzer: This guy down the street from me sometimes leaves his back door unlocked. I told him about it once, but he
still does it. If I had the chance to do it over, I would go in the back door, shoot him, and take all his money and consumer electronics. It's the only way to
get through to him.</p>
        <p class="c-chat-log__code">Acid Phreak: Jef Poskanker (Puss? Canker? yechh) Anyway, now when did you first start having these delusions where computer
hacking was even *remotely* similar to murder?</p>
        <p><i>Presented with such a terrifying amalgam of raw youth and apparent power, we fluttered like a flock of indignant Babbitts around the Status Quo,
defending it heartily. One former hacker howled to the Harper's editor in charge of the forum, "Do you or do you not have names and addresses for these
criminals?" Though they had committed no obvious crimes, he was ready to call the police.</i></p>
        <p><i>They finally got to me with:</i></p>
        <p class="c-chat-log__code">Acid: Whoever said they'd leave the door open to their house... where do you live? (the address) Leave it to me in mail if
you like.</p>
        <p><i>I had never encountered anyone so apparently unworthy of my trust as these little nihilists. They had me questioning a basic tenet, namely that
the greatest security lies in vulnerability. I decided it was time to put that principal to the test...</i></p>
        <p class="c-chat-log__code">Barlow: Acid. My house is at 372 North Franklin Street in Pinedale, Wyoming. If you're heading north on Franklin, you go
about two blocks off the main drag before you run into hay meadow on the left. I've got the last house before the field. The computer is always on…
<br/>Barlow:
And is that really what you mean? Are you merely just the kind of little sneak that goes around looking for easy places to violate? You disappoint me, pal. For
all your James Dean-On-Silicon rhetoric, you're not a cyberpunk. You're just a punk.</p>
        <p class="c-chat-log__code">Acid Phreak: Mr. Barlow: Thank you for posting all I need to get your credit information and a whole lot more! Now, who is
to blame? ME for getting it or YOU for being such an idiot?! I think this should just about sum things up.</p>
        <p class="c-chat-log__code">Barlow: Acid, if you've got a lesson to teach me, I hope it's not that it's idiotic to trust one's fellow man. Life on
those
terms would be endless and brutal. I'd try to tell you something about conscience, but I'd sound like Father O'Flannigan trying to reform the punk that's about
to gutshoot him. For no more reason that to watch him die. But actually, if you take it upon yourself to destroy my credit, you might do me a favor. I've been
looking for something to put the brakes on my burgeoning materialism.</p>
        <p><i>I spent a day wondering whether I was dealing with another Kevin Mitnik before the other shoe dropped:</i></p>
        <p class="c-chat-log__code">Barlow: ... With crackers like acid and optik, the issue is less intelligence than alienation. Trade their modems for
skateboards and only a slight conceptual shift would occur.</p>
        ...
        <cite><span class="c-ref" data-ref-source-id="104" data-ref-type="zitat" data-ref-desc="">John Perry Barlow</span></cite>
      </div>

      <p>In dieser kurzen Konversation offenbaren sich eine Vielzahl an Erkenntnissen über menschliche Facetten und deren Wechselwirkungen im Kontext des
virtuellen Cyberspaces. Barlow bekommt dessen verschobenen Gesetzlichkeiten das erste Mal persönlich zu spüren. Er behandelt die Hacker wie jugendliche Skater,
welche er in der physischen Welt, unter Umständen durch sein Alter, seine ausstrahlende Autorität oder seine überlegene physische Konstitution, maßregeln
könnte. Im Cyberspace sind diese Maxime jedoch ungültig. Zusätzlich gibt Barlow seine Anonymität auf und verliert damit seinen einzigen Schutz im virtuellen
Raum, welchen die Hacker kurze Zeit darauf <span class="c-ref" data-ref-source-id="71" data-ref-type="ref" data-ref-parameter="&t=44m51s"
data-ref-desc="">bestrafen.</span></p>
...
es zeigt einen Trend, auf welchem sich beispielsweise im Online Gaming – eine weitere wichtige Komponente für den Erfolg des Internets – durch z.B. das
...
telefonischen Kontakt aufzunehmen. Er wählt dem seinem Naturell entsprechenden, kommunikativen Weg und erkennt Parallelen zu seinen persönlichen Ansichten. Er
lernt die Hacker mit der Zeit besser kennen und begreift, dass sich hinter den Aliasen keine böswilligen Absichten verbergen. Barlow versteht sich ab diesem
Zeitpunkt als der, nach eigenen Aussagen, Scoutmaster (z.d. Pfadfinderführer) der jüngeren Hacker und bleibt mit der Gruppe in freundschaftlichem Kontakt.</p>

      <blockquote>
        <p>Governments of the Industrial World, you weary giants of flesh and steel, I come from Cyberspace, the new home of Mind. On behalf of the future, I
ask you of the past to leave us alone. You are not welcome among us. You have no sovereignty where we gather.</p>
        <cite><span class="c-ref" data-ref-source-id="105" data-ref-type="zitat" data-ref-desc="Einleitung: ">John Perry Barlow</span></cite>
      </blockquote>

      <div class="c-person">
        <div class="c-person__object">
          <img class="c-person__image" src="./assets/img/barlow.png" alt="John Perry Barlow"
data-source="http://farm2.staticflickr.com/1321/835393447_aaee27aa87_o.jpg" data-article="https://alchetron.com/John-Perry-Barlow-158286-W"/>
        </div>
        <div class="c-person__content">
          <h4 class="c-person__name">John Perry Barlow</h4>
          <p class="c-person__bio">Durch seine persönlichen Erfahrungen mit den Hackern und Einsichten in deren Szene, die „WELL Community“ sowie seine
Beobachtungen der Internetentwicklung, mit vermehrt auftretenden, häufig unverhältnismäßigen Konflikten der Hackerszene in Verbindung mit staatlichen
Institutionen, konkretisiert sich Barlows Engagement für die Erhaltung der Netzneutralität und der generellen Freiheit des Internets. Bereits 1990 gründet
Barlow mit weiteren Aktivisten die <span class="c-ref" data-ref-source-id="106" data-ref-type="ref" data-ref-desc="">Electronic Frontier Foundation</span>
(<abbr title="Electronic Frontier Foundation">EFF</abbr>), eine non-profit Organisation, welche sich für vor allem vor Gerichten und durch
Öffentlichkeitsarbeit, für den Erhalt der Grundrechte des Einzelnen im Informationszeitalter einsetzt. In ihrem Programm verschreiben sie sich ebenfalls dem
Schutz vor digitaler Überwachungen, welche immer mehr zunehmen. Die <abbr title="Electronic Frontier Foundation">EFF</abbr> unterstützt erfolgreich Hacker,
Organisationen und Unternehmungen wie bereits Mark
Abene, <span class="c-ref" data-ref-source-id="107" data-ref-type="ref" data-ref-desc="">Bruce Sterling</span>, <span class="c-ref" data-ref-source-id="108"
data-ref-type="ref" data-ref-desc="">Steve Jackson Games</span>,
<span class="c-ref" data-ref-source-id="109" data-ref-type="ref" data-ref-desc="">Tor Browser,</span> oder <span class="c-ref" data-ref-source-id="110"
data-ref-type="ref" data-ref-desc="">WikiLeaks.</span></p>
        </div>
      </div>

      <p>Im Jahr 1996 publiziert Barlow sein berühmtes Manifest:<span class="c-ref" data-ref-source-id="105" data-ref-type="ref" data-ref-desc="">A Declaration
of the Independence of Cyberspace.</span> Trotz der möglichen Gefahren der Hackerszene,
mit denen er selbst persönliche Erfahrungen macht, erkennt Barlow die Wichtigkeit der <span class="c-ref" data-ref-source-id="111" data-ref-type="ref"
data-ref-desc="">Freiheit des Internets</span> und dessen fundamentales Potential Menschen auf der
Welt – ungeahnt ihrer Herkunft, Ethik oder persönliche Ansichten – zu verbinden, ohne konventionelle Regeln oder Normen, sondern lediglich auf der Basis von
...
Entwicklung des Internets gesteht selbst Barlow inzwischen ein, dass sein Manifest optimistischer ausgelegt ist, als es der Realität gerecht werden könnte.
...
des Internets. Der Mythos des in der Dunkelheit, vor dem flackernden Bildschirm sitzenden Hackers löst sich spätestens mit dem White-Hat Aktivismus auf.
Viele
Hacker, darunter Abene, arbeiten inzwischen im <span class="c-ref" data-ref-source-id="112" data-ref-type="ref" data-ref-desc="" data-ref-hide-kneenote><abbr
title="Information Security">InfoSec</abbr> Sektor,</span> um u.a. das Internet sicherer zu machen.
Von dem einst „wilden Westen“*, bestehend aus rudimentären <abbr title="Bulletin Board System">BBS</abbr> „Mikrokosmen“, bewohnt von einer anonymen Community
aus Hackern und Technik Enthusiasten, entwickelt sich das Internet spätestens mit der
Implementierung von Web 2.0 Features zu einer umfassend vernetzten digitalen Parallelwelt der Gesellschaft.
        ...
        <span class="c-notes-side-hook">
          <span class="c-notes-side">
            ...
            <span class="c-note-side">
              <span class="c-note-side__content">
                <strong class="c-note-side__headline">Der wilde Westen</strong>
                <span class="c-note-side__text">  Barlow vergleicht diese Zeit des Internets in seiner Veröffentlichung Crime and Puzzles, mit dem Wilden
Westen. Weitgehend unerforscht und ohne die Reglementierungen von heute. Bezeichnung, wie White- oder Black Hat Hacker haben ihren Ursprung ebenfalls
in dieser Analogie.</span>
              </span>
            </span>
          </span>
        </span>
...
kristallisieren sich erfolgreiche Marktführer der einzelnen Sparten heraus. So dominiert z.B. Google den Suchmaschinenmarkt und setzt sich deutlich gegen seine
...
verdrängt. Die Technologie-Unternehmen verdrängen nicht nur ihre unmittelbare Konkurrenz, sondern überholen sogar traditionell erfolgreiche Unternehmen aus der
...
etabliert bzw. eingekauft z.B. <span class="c-ref" data-ref-source-id="113" data-ref-type="bsp" data-ref-desc="">Occulus,</span> <span class="c-ref"
data-ref-source-id="114" data-ref-type="bsp" data-ref-desc="">Instagram,</span>
<span class="c-ref" data-ref-source-id="115" data-ref-type="bsp" data-ref-desc="">Boston Dynamics,</span> usw.</p>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="116" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="117" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>
...
Gesellschaft.</p>
      <p class="o-p--tie">Popkulturelle Phänomene des digitalen Cyberspace wie sog. „Selfies“ oder die <span class="c-ref" data-ref-source-id="118"
data-ref-type="ref" data-ref-desc="">forcierte Selbstdarstellung</span> von trivialen Alltagserlebnissen,
wie beispielsweise das Fotografieren von Nahrungsmitteln vor dem Verzehr, Blogging und Vlogging, bahnen sich einzig durch Nutzung und Verbreitung
innerhalb der neuen Meta Medien ihren Weg in die physische Welt.</p>
      <p class="o-p--tie">Die verstärkte Nutzung der digitalen Meta Medien gehen einher mit positiven sowie negativen Ansätzen. Die verstärkte Partizipation
und höhere Informationsdichte ermöglicht einen vereinfachten Zugang zu diversen Themenbereichen ohne bestimmte unverhältnismäßige und technische Kenntnisse zu
...
kreieren. Programmierer können mithilfe sog. „APIs“ auf vorgefertigte Assets von Großunternehmen, wie Google zugreifen und sie für ihre Zwecke <span
class="c-ref" data-ref-source-id="4" data-ref-type="vgl" data-ref-desc="S.16">nutzen.</span> Des
...
fungieren dabei als <span class="c-ref" data-ref-source-id="118" data-ref-type="ref" data-ref-desc="">Katalysator</span> jeglicher menschlicher Eigenschaft in
der Funktionalitäten, wie Likes und Follows, keine fundierten Anhaltspunkte für die Qualität
der jeweiligen Information darstellen, es dem Nutzer jedoch suggerieren.</p>
      <p class="o-p--tie">An dieser Stelle können weitere Nachforschungen betrieben werden, welche von sog. <span class="c-ref" data-ref-source-id="119"
data-ref-type="ref" data-ref-desc="">Filterblasen,</span> über
        den möglichen <span class="c-ref" data-ref-source-id="120" data-ref-type="ref" data-ref-desc="">Datenhandel von Nutzern</span> bis zu möglichen <span
class="c-ref" data-ref-source-id="74" data-ref-type="ref" data-ref-desc="">digitalen Wahlmanipulationen</span> führen können. Ohne solche Ansätze und deren
Wahrheitsgehalt im Detail zu untersuchen sind die
...
reproduziert werden:</p>
      ...
      <a href="https://www.facebook.com" target="tab"><img style="image-rendering: pixelated;" src="./assets/img/fbprofil.png" alt="Exemplarisches Facebook
Profil indem der Alt Tag, einsehbar über den Quelltext, den folgenden Text enthält: Dein Profilbild, Bild könnte enthalten: eine oder mehrere Personen,
Personen, die stehen und im Freien."/></a>
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="122" data-ref-type="ref" data-ref-desc="Exemplarisches Facebook Profil, indem der Alt Tag, einsehbar über den
Quelltext, den folgenden Text enthält: Dein Profilbild, Bild könnte enthalten: eine oder mehrere Personen, Personen, die stehen und im Freien. "
data-ref-hide></span>
        </div>
      </div>
      ...
      <a href="https://www.facebook.com" target="tab"><img style="image-rendering: pixelated;" src="./assets/img/fbad.png" alt="In diesem Fall wurden diverse
Funktionen und Unterseiten auf der Webseite von der Modemarke Eton besucht. Nach nur einem Neuladen des Facebook Streams tauchen Produkte von Eton als
gesponserte Werbung im Facebook Feed auf."/></a>
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="121" data-ref-type="ref" data-ref-desc="In diesem Fall wurden diverse Funktionen und Unterseiten auf der
Webseite von
der Modemarke Eton besucht. Nach nur einem Neuladen des Facebook Streams tauchen Produkte von Eton als gesponserte Werbung im Facebook Feed auf. "
data-ref-hide></span>
        </div>
      </div>

      <p>Diese beiden simplen Beispiele verdeutlichen die Digitalisierung von physischem Input an der jeweiligen Schnittstelle. Neben der Auswertung von Text
und Interaktion ist ebenfalls die automatisierte Verarbeitung von Bildmaterial möglich. Es handelt sich dabei um keine versteckte Funktionalitäten. Sie wurden
öffentlich von Facebook vorgestellt und bereits in diversen Blogartikeln diskutiert.</p>
...
ersten Windows/Apple Betriebssysteme oder dem sog. burgermenu im mobilen Webdesign.</p>
      <p class="o-p--tie">Viele der ehemaligen Hacker und Aktivisten arbeiten inzwischen in verschiedenen Teilen der IT Branche in jenen, neben den
Protagonisten wie staatlichen Vertretern des Gesetzes und technischen „Enthusiasten“ (Hacker und Aktivisten), interagieren nun ebenfalls verstärkt
einflussreiche Unternehmen und Organisationen (Google, Facebook, <abbr title="Electronic Frontier Foundation">EFF</abbr>, usw.) sowie reguläre Nutzer. Eine
markante Eigenschaft der liberalen Aktivisten besteht
darin, ungeachtet von persönlichen Eigenschaften und Beziehungen, die Grundideale aller Nutzer zu wahren. So <span class="c-ref" data-ref-source-id="123"
data-ref-type="ref" data-ref-desc="">kritisiert</span> beispielsweise der Whistleblower Julian
Assange die <abbr title="Electronic Frontier Foundation">EFF</abbr> in ihrer Handlungsweise große Mengen an Geld von großen Unternehmen, wie Google anzunehmen
und damit die Netzneutralität in Gefahr zu bringen,
obwohl Assange von der <abbr title="Electronic Frontier Foundation">EFF</abbr> maßgeblich unterstützt wurde. Dieser Austausch an Kritik ist, ungeahndet von
...
existiert
für die digitale Revolution weder eine vorausgehende ausführliche Untersuchung von technologischen Neuerungen, noch ein festgelegtes Enddatum. Die
...
beispielsweise durch die Verwertung persönlicher Nutzerdaten für das Generieren von Profit. Zum anderen begünstigen ihre leistungsstarken APIs und diversen
Entwicklungszweige das Wachstum neuer Technologien. Sie befinden sich somit in einer besonderen Grauzone in jener einzelne Protagonisten wie beispielsweise
Steve Jobs, Alan Kay, Elon Musk, Ray Kurzweil, Larry Page, etc. einen bedeutenden Unterschied ausmachen können.</p>

      <blockquote>
        <p>The truth is that I find big companies to be essential, and have enjoyed working with them. I have helped to create startups that are now part of
Oracle, Adobe, Pfizer, and Google. Working in Microsoft’s research labs has been great fun in part because of the Kinect project. Thousands of people were
needed to bring what we once upon a time called an ‘avatar camera’ to market for the first time and to promptly sell tens of millions of them. It was the
selling of tens of millions that facilitated a spontaneous hacker community of thousands to create hacks.</p>
        <cite><span class="c-ref" data-ref-source-id="72" data-ref-type="zitat" data-ref-desc="S.253 ">Jaron Lanier</span></cite>
      </blockquote>
      ...
      <h2 id="artifizielle-realitaeten">Artifizielle Realitäten</h2>

      <blockquote>
        <p>People who are really serious about software should make <br/>their own hardware.</p>
        <cite><span class="c-ref" data-ref-source-id="124" data-ref-type="zitat" data-ref-desc="" data-ref-hide-kneenote>Alan Kay</span></cite>
      </blockquote>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="207" data-ref-type="ref" data-ref-desc="" data-ref-hide></span>
        </div>
      </div>
...
Vergangenheit erforderlich. Der Verlauf der Computergeschichte zeichnet sich durch repetitive Aspekte und die starke Verknüpfung unterschiedlicher
Entwicklungen untereinander aus. Daraus lassen sich relevante Faktoren für potentielle Software induzierte Paradigmenwechsel eruieren. Aus diesem Grund
...
sondern ebenfalls das Ineinander- und Übergreifen diverser Themengebiete. Kay beschäftigt sich nicht nur ausschließlich mit der Weiterentwicklung
grafischer
...
Visualisierung, überzeugen die zeitgeistigen Produkte durch die Nutzung ausreichend leistungsstarker Hard- und Software. Neben der primär visuellen Sensorik
...
Tango</span>) und somit nur im übertragenen Sinne in das Blickfeld des Nutzers versetzt werden.</span>
      ...
      <div class="c-video">
        <iframe class="c-video__item" src="https://www.youtube.com/embed/q4zr5Eq_F5g?start=212&autoplay=0&showinfo=0&controls=1&vq=hd720"
allowfullscreen></iframe>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="215" data-ref-type="bsp" data-ref-parameter="?t=3m22s" data-ref-desc="Virtual Reality Beispiel"
data-ref-hide></span>
        </div>
      </div>
      ...
      <div class="c-video">
        <iframe class="c-video__item" src="https://www.youtube.com/embed/Qryf2F_QfXg?start=50&autoplay=0&showinfo=0&controls=1&vq=hd720"
allowfullscreen></iframe>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="216" data-ref-type="bsp" data-ref-parameter="?t=50s" data-ref-desc="Augmented Reality Beispiel"
data-ref-hide></span>
        </div>
      </div>
      ...
      <div class="c-video">
        <iframe class="c-video__item" src="https://www.youtube.com/embed/yvgPrZNp4So?start=930&autoplay=0&showinfo=0&controls=1&vq=hd720"
allowfullscreen></iframe>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="214" data-ref-type="bsp" data-ref-parameter="?t=15m30s" data-ref-desc="Mixed Reality Beispiel"
data-ref-hide></span>
        </div>
      </div>
...
besseren Verständnis bzw. Erlernen von Inhalten aus Themengebieten, wie z.B. <span class="c-ref" data-ref-source-id="217" data-ref-type="bsp"
data-ref-desc="">Medizin,</span> Physik, Technik, Sport, usw. mithilfe realitätsnaher Darstellungen, der
...
Ansatz bezieht sich umso mehr auf die Ermittlung des Potentials und Durchsetzungsvermögens dieser Medien.</p>
      <p class="o-p--tie">Durch die bisherigen Beobachtungen der Computer- und Softwareentwicklungen stellt sich die Frage, ob sich das Medium der Head
Mounted
...
Erwartungen und der Hype um die Virtual Reality Komponenten, welche sich bisher als die „natürlichste“ Annäherung an den digitalen Cyberspace erweisen,
dementsprechend hoch.</p>
      <p class="o-p--tie">Diverse Investitionen in ambitionierte Projekte, wie <span class="c-ref" data-ref-source-id="218" data-ref-type="ref"
data-ref-desc="">MagicLeap,</span> <span class="c-ref" data-ref-source-id="113" data-ref-type="ref" data-ref-desc="">Oculus,</span> etc., wurden bereits
initiiert. Prominente Plattformen, wie
YouTube und SketchFab implementieren Funktionen, wie beispielsweise die 360° Ansicht von Videos, 3D Objekte und weitere digitale Inhalte. Mit dem Aufkauf
von Oculus verknüpft Facebook die VR Technologie mit ihrem gleichnamigen Social Media Portal und gibt durch <span class="c-ref" data-ref-source-id="134"
data-ref-type="ref" data-ref-desc="">Social VR</span> und Erfahrungen aus der App <span class="c-ref" data-ref-source-id="135" data-ref-type="ref"
data-ref-desc="">Rooms</span>
Einblicke in die zukünftige digitale Kommunikation und Interaktion in sozialen Netzwerken als auch darüber hinaus. Sonys Playstation VR führt das Medium in
der
...
Bemühungen unterschiedlicher Unternehmen und der jeweiligen Branchen zeigen das allgemeine Engagement auf, die neuen Medien gesellschaftlich zu
etablieren.</p>

      <h5><span class="c-icon-asterisk"></span> <span class="c-ref" data-ref-source-id="219" data-ref-desc="" data-ref-type="ref">Did you know...?</span></h5>
...
Vorteilen ist damit unweigerlich eine generelle Problematik verbunden. Die Diversität verschiedener Hardwarekomponenten und die vielen verschiedenen
...
essentiell identischer grundlegender Strukturen und sog. Engines, wie beispielsweise <span class="c-ref" data-ref-source-id="137" data-ref-type="ref"
data-ref-desc="">Unity,</span> spezifische Anwendungssoftware. Sie profitieren dementsprechend
...
into the market.</p>
        <p>OpenXR presented the opportunity to work with other industry leaders – Valve, Oculus, Samsung, Google and others – to formulate a standard that
would
...
formally started just a few weeks ago, so the average holds here, we'll have the first release of the standard in mid 2018, but of course we might finish
before
...
übersetzen und zum
anderen größere Trackingbereiche als die Sensoren der aktuellen Geräte eröffnen, sind schon seit Filmen wie <span class="c-ref" data-ref-source-id="145"
data-ref-type="ref" data-ref-desc="">Herr der Ringe</span> oder <span class="c-ref" data-ref-source-id="146" data-ref-type="ref" data-ref-desc="">Avatar</span>
bekannt und
...
Immersion zu erreichen, sie scheitern oftmals an ihrer Komplexität und den verbundenen Kosten zusätzlich zu den ohnehin vergleichsweise teuren Endgeräten.
      ...
      <span class="c-notes-side-hook">
          <span class="c-notes-side">
            ...
            <span class="c-note-side">
              <span class="c-note-side__content">
                <strong class="c-note-side__headline"><span class="c-ref" data-ref-source-id="149" data-ref-type="ref" data-ref-desc="Lord Helmchen, "><abbr
title="Lord Helmchen ist ein Charakter aus dem Kinofilm Spaceballs, welcher wie sein Name vermuten lässt, einen überdimensionierten Helm trägt.">Lord
Helmchen?</abbr></span></strong>
...
primär durch ihr unnatürliches Erscheinungsbild, <abbr title="Entwickler">Developer</abbr> Status und einen noch höheren Preis.
      ...
      <p>Womit sich der Preis als ein weiterer Kritikpunkt offenbart. Obwohl zeitgeistige Produkte, speziell technische Meilensteine der <abbr title="Head
Mounted Display bzw. Datenhelm">HMD</abbr>-Entwicklung auf
Konsumenten Niveau darstellen, sind die leistungsstarken stationären Geräte immer noch sehr hochpreisig. Günstigere stationäre Geräte sind bereits in der
<span class="c-ref" data-ref-source-id="150" data-ref-type="bsp" data-ref-desc="">Entwicklung</span> jedoch noch nicht auf dem Markt. Unternehmungen, wie
beispielsweise <span class="c-ref" data-ref-source-id="153" data-ref-type="bsp" data-ref-desc="">Google Cardboard</span> und Samsung <span class="c-ref"
data-ref-source-id="223" data-ref-type="bsp" data-ref-desc="">Gear VR</span> dagegen präsentieren ihre Produkte bereits
kostengünstig, können aber weder der Leistung noch dem Gefühl der Immersion von stationären <abbr title="Head Mounted Display bzw. Datenhelm">HMD</abbr>s
gerecht werden.</p>
      <p class="o-p--tie">Nach der Analyse der verschiedenen <abbr title="Head Mounted Display bzw. Datenhelm">HMD</abbr> Technologien stellt sich unweigerlich
die Frage, wie und ob die Missstände der aktuellen
Technologien zeitnah behoben werden können, um eine großflächige gesellschaftliche Nutzung zu erreichen. Nach den anfänglichen Prognosen diverser Blogs und
Enthusiasten sowie dem Engagement zugehöriger Unternehmen häuften sich zuletzt die Anzahl der Kritiker. Selbst Persönlichkeiten und Verfechter der VR
Technologien,
wie Mark Zuckerberg (Facebooks CEO) mahnen zur Geduld in Bezug auf zukünftige VR Entwicklungen.</p>
      <p class="o-p--tie">Zunächst wird dementsprechend eruiert, welche Faktoren für ein erfolgreiches Produkt relevant sind. Durch die bisherige Analyse
zeichnen sich die Erfolgsfaktoren der vergangenen und bis heute präsenten Technologien und deren Einflüsse deutlich ab. Die folgenden Schlüsselkomponenten sind
in ihren Eigenschaften stark untereinander vernetzt, welche sich teilweise verstreut über die verschiedenen Dekaden in Mustern wiederholen. In letzter Instanz
separieren sich diese zu einzelnen Indikatoren für eine vage Erfolgsprognose entsprechender Medien bzw. Technologien.</p>

      <ol>
        <li><strong>Balance of Price</strong> Die Angleichung von Preisen eröffnet Technologien dem Massenmarkt, womit sich der Zugriff für eine
breites Spektrum an Konsumentengruppen eröffnet. Prominente Beispiele sind dabei die Entwicklung der Mikrocomputer und Smartphones (speziell der Erfolg von
Android Smartphones), in denen sich der umfassende Erfolg erst ab der Preisrelativierung für die jeweilige Technologie einstellt.</li>
...
Anwendern
ebenfalls Nutzer aus anderen Themenbereichen Zugriff auf das jeweilige Medium erlangen. Historische Beispiele dafür sind die Einführungen von GUIs und des Web
2.0 als neuartige Schnittstellen der Interaktion sowie abermals die Entwicklung der Smartphone Industrie.</li>
        <li><strong>Independence and Freedom</strong> Die Wahrung der fundamentalen ethischen Eigenschaften von gesellschaftlich wirksamen Technologien,
angetrieben durch die frühen Entwicklungen der Hacker Community in Medien wie dem Internet, stellen die Grundlagen der erfolgreichen Kommunikation und
Kollaboration im digitalen Cyberspace dar.</li>
...
Technologien begünstigen. Dies zeichnet sich primär in den Zukunftsprognosen von Persönlichkeiten wie John von Neumann, Alan Turing, Alan Kay und weiteren
popkulturellen Visionen der frühen Historie ab.</li>
        <li><strong>Interconnectivity</strong> Neben Zeitgeist und Partizipation sind ebenfalls die Auswirkungen auf weitere unabhängige Themenbereiche ein
entscheidender Faktor. Das Potential, hilfreiche Erweiterungen für z.B. Medizin, Kultur, Technik und andere relevante gesellschaftliche Themenbereiche zu
schaffen, verdeutlicht ebenfalls die Relevanz des jeweiligen Mediums.</li>
        <li><strong>Based on Software</strong> Der digitale Markt verdrängt erfolgreich traditionelle Industrien der physischen Welt. Ein Großteil
erfolgreicher Unternehmungen basiert auf der exzessiven Nutzung von Software. Die Vorteile von Software zeichnen sich durch die Analyse der Historie in ihrer
Flexibilität, sich den Gegebenheiten des jeweiligen Vorhabens adaptiv anzupassen, ab und ergänzen sich zusätzlich durch alle vorherigen erwähnten
Komponenten.</li>
      </ol>

      <p>Das Potential für die Erfüllung <strong>jeder</strong> dieser Faktoren manifestiert sich, im Gegensatz zu den klassischen VR Geräten und deren
Anwendungen, in den Entwicklungen von Mobile- bzw. WebVR Technologien. Natürlich sind diese Indikatoren nicht unwiderlegbar oder universell gültig. Sie zeigen
...
Programmen und Tools wie Unity bleibt, durch die potentiell mögliche Exportfunktion zu WebVR, ebenfalls erhalten.</p>
      ...
      <div class="c-notes-marginal">
        <div class="c-notes-marginal__item">
          <span class="c-ref" data-ref-source-id="176" data-ref-type="bsp" data-ref-desc="Mit bereits wenigen Zeilen an Code, kann eine simple Visualisierung
und Interaktion realisiert werden." data-ref-hide></span>
        </div>
      </div>
...
Web sind vorstellbar und verändern die Darstellung des Internets und Cyberspace bei erfolgreicher Etablierung in Zukunft maßgeblich.</p>
      ...
      <blockquote>
        ...
        <cite><span class="c-ref" data-ref-source-id="167" data-ref-type="zitat" data-ref-desc="Plenarprotokoll 13/41 S.03183, ">Helmut Kohl bzw. August
Bebel</span></cite>
      </blockquote>
...
und der Grad der Implementierung werden letztendlich über die Zukunft der gesellschaftlichen Entwicklung bestimmen. Ein Vorgehen indem die besten Eigenschaften
...
zwangsweise augmentieren muss oder Maschinen menschliche Denkstrukturen auslesen sollten, sondern vielmehr, dass zukünftige, intelligente Maschinen die
zugrunde
liegenden, ethischen Werte der Menschheit vermittelt bekommen und für den Menschen Schnittstellen bereitgestellt werden, welche digitale Prozesse auf
natürliche
