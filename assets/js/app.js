...
var _Ref = require('./components/Ref');
...
},{"./components/Ref":2,"jquery":3}],2:[function(require,module,exports){
'use strict';
...
_jquery2.default.getJSON('sources.json', function (data) {

  // Get source data
  var sources = data;

  // Generate refs
  (0, _jquery2.default)('.c-ref').each(function (i) {
    ...
    if (refHide === undefined) {
      ...
      // Readd ref hook name
      (0, _jquery2.default)('.c-ref__name', $this).append(text);

      $this.append('<a class="c-ref__short-link" href="#source-' + sources[refId].id + '"></a>');
      (0, _jquery2.default)('.c-ref__short-link', $this).append('<sup class="c-ref__short">[' + i + ']</sup> ');
    }
    ...
    if (refHideKneenote === undefined) {
      ...
      if (!$currentPosition.length > 0) {
        ...
        var $allP = (0, _jquery2.default)('p');
        var pIndex = $allP.index((0, _jquery2.default)('.js-temp-marker'));
        var $nextPosition = $allP.eq(pIndex + 1);
        (0, _jquery2.default)('.js-temp-marker').remove();
        $currentPosition = $betweenPosition = $nextPosition.prev();
      } else {
        $nextPosition = $currentPosition.next();
        var $betweenPosition = (0, _jquery2.default)('<div class="c-notes-marginal"></div>');
      }

      var $kneenote = (0, _jquery2.default)('<div class="c-notes-marginal__item"><div class="c-kneenote"></div></div>');
      ...
      if (!$betweenPosition || refHide === undefined) {
        (0, _jquery2.default)($betweenPosition).insertAfter($currentPosition);
      ...
      if ($betweenPosition.hasClass('c-notes-marginal')) {
        ...
        (0, _jquery2.default)('.c-ref__href', $kneenote).append('<span class="c-ref__type">' + refType + '</span> ');
        (0, _jquery2.default)('.c-ref__href', $kneenote).append('<sup class="c-ref__id">' + i + '</sup> ');
        ...
        if (refDesc) {
          (0, _jquery2.default)('.c-ref__desc', $kneenote).append('<span>' + refDesc + '</span>');
        }

        // Vgl auto kneenote sources
        if (!refHideSources && refType === 'zitat') {
          if (sources[refId].year) {
            (0, _jquery2.default)('.c-ref__desc', $kneenote).append(', <span>' + sources[refId].year + '</span>');
          }
          if (sources[refId].yearId) {
            (0, _jquery2.default)('.c-ref__desc', $kneenote).append('<span>' + sources[refId].yearId + '</span>');
          }
          if (sources[refId].authorSurname) {
            (0, _jquery2.default)('.c-ref__desc', $kneenote).append(', <span>' + sources[refId].authorSurname + '</span>');
          } else if (sources[refId].author) {
            (0, _jquery2.default)('.c-ref__desc', $kneenote).append(', <span>' + sources[refId].author + '</span>');
          }
        }
        ...
        if (!refHideSources && refType !== 'vgl' && refType !== 'zitat') {
          if (sources[refId].entity) {
            (0, _jquery2.default)('.c-ref__desc', $kneenote).append('<span>' + sources[refId].entity + '</span> ');
          }
          if (sources[refId].org) {
            (0, _jquery2.default)('.c-ref__desc', $kneenote).append('<span>' + sources[refId].org + '</span> ');
          }
          if (sources[refId].year) {
            (0, _jquery2.default)('.c-ref__desc', $kneenote).append('<span>' + sources[refId].year + '</span> ');
          }
          ...
          if (sources[refId].author) {
            ...
            if (sources[refId].authorPrename) {
              (0, _jquery2.default)('.c-ref__desc', $kneenote).append('<span>' + sources[refId].authorPrename + '</span> ');
            }
            if (sources[refId].authorSurname) {
              (0, _jquery2.default)('.c-ref__desc', $kneenote).append('<span>' + sources[refId].authorSurname + '</span> ');
            }
