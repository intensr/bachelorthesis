...
// Create ´kneenotes´
(0, _jquery2.default)('.c-ref:not(.c-ref--video)').each(function (i) {
  ...
  if (!$thisParagraph.next().hasClass('c-notes-marginal')) {
    (0, _jquery2.default)('<div class="c-notes-marginal"></div>').insertAfter($thisParagraph);
  }
